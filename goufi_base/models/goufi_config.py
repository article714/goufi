...
class GoufiConfigSettings(models.TransientModel):
    ...
    def set_config_needs_partner(self):
        return (
            ...
            .sudo()
            .set_param("goufi.config_needs_partner", self.config_needs_partner)
        )
    ...
    def set_delete_obsolete_files(self):
        return (
            self.env["ir.config_parameter"]
            .sudo()
            .set_param("goufi.delete_obsolete_files", self.delete_obsolete_files)
        )
    ...
    def set_goufi_default_language(self):
        return (
            self.env["ir.config_parameter"]
            .sudo()
            .set_param("goufi.goufi_default_language", self.goufi_default_language.id)
        )

    @api.model
    def get_default_config_needs_partner(self, fields):
        return {
            "config_needs_partner": True
            if self.env["ir.config_parameter"]
            .sudo()
            .get_param("goufi.config_needs_partner")
            == "True"
            else False
        }
    ...
    def get_default_obsolete_files(self, fields):
        return {
            ...
            if self.env["ir.config_parameter"]
            .sudo()
            .get_param("goufi.delete_obsolete_files")
            == "True"
            else False
        }
