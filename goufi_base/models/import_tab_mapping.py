...
class TabMapping(models.Model):
    ...
    default_header_line_index = fields.Integer(
        string=_(u"Default Header line"),
        help=_(
    ...
    needs_col_mappings = fields.Boolean(
        string=_(u"Needs column mappings"),
            ...
            if values["parent_configuration"] != None:
                ...
                if len(found) == 1:
                    ...
                    if not "default_header_line_index" in values:
                        values[
                            "default_header_line_index"
                        ] = config.default_header_line_index
